       ...
       <!-- <script src="https://cdn.agora.io/sdk/web/AgoraRTCSDK-2.4-latest.js"></script> 
        ...
        $(document).ready(function () {
            ...
            $('video').each(function () {
                 //playing the video
                 var yo = $(this).get(0);
                 yo.addEventListener('loadeddata', function() {
...
/*
  ...
  */          
            ...
            $(".maincolumn").on("click", ".videosection", function () {
                window.location.href = "hlthwatchdetail.php?room=" + channelId;
    ...
    <body>
        <div class="maincolumn">
                ...
                <?php
                    ...
                    echo "</div>Henry 24 M</div><div class='videosection2'> <video width='500' height='300' autoplay loop muted='muted'>
  <source src='images/alex2.mp4' type='video/mp4'>
Your browser does not support the video tag.
</video> Alex 30 M</div>  <div class='videosection2'> <video width='500' height='300' autoplay loop muted='muted'>
  <source src='images/sam.mp4' type='video/mp4'>
Your browser does not support the video tag.
</video> Sam 29 M</div> 

<div class='videosection2'> <video width='500' height='300' autoplay loop muted='muted'>
  <source src='images/jon.mp4' type='video/mp4'>
Your browser does not support the video tag.
</video> Jon 30 M</div></div>";
                    
                    
                echo "<div class='patientinfo'>"
                    . "<ul>
  <li>Rebecca Priestly (sitting 30min) 29 F</li>
  <li>Laura Kate (sitting 1 hour) 28 F</li>
  <li>Kevin Turley (laying down 2 hour) 64 M</li>
  <li>Anthony Zarn (laying down 1 hour) 78 M</li>
</ul></div>";
